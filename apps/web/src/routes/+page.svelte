...
<section class="bg-gradient-to-br from-amber-100 to-emerald-50 px-4 py-12 text-center">
	...
	<p class="mx-auto mb-4 max-w-3xl text-lg text-gray-700">
		...
		runes, featuring automatic memory management, advanced array operations, and seamless Zod/Valibot
...
<section class="mx-auto max-w-6xl px-4 py-10">
	...
	<div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
		...
		<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
			...
			<p class="text-gray-600">
				Full TypeScript support with Zod, Valibot, or custom validators.
			</p>
		</div>
...
const form = createForm(customValidator, {
  name: 'John',
...
{/if}`}</code
		...
		<h2 class="mt-8 mb-4 text-xl font-semibold">Valibot Schema Example</h2>
...
<section class="mx-auto max-w-4xl px-4 py-10">
	...
	<div class="mb-8 rounded-lg border border-gray-200 bg-white p-6">
		<h3 class="mb-4 text-xl font-semibold">Imports</h3>
		<pre class="overflow-x-auto rounded bg-gray-100 p-4 text-sm"><code
				>{`// Custom validators
import { createForm } from 'rune-form';
...
// Valibot adapter
import { createForm } from 'rune-form/valibotAdapter';`}</code
			></pre>
	</div>
	...
	<div class="grid grid-cols-1 gap-8 md:grid-cols-2">
		<div class="rounded-lg border border-gray-200 bg-white p-6">
			...
			<ul class="space-y-2 text-sm">
				<li>
					<code class="rounded bg-gray-100 px-1">createForm(schema, initialData?)</code>
				</li>
				<li>

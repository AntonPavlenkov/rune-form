import { RuneForm, type Validator } from './RuneForm.svelte.js';
import type { CustomValidator } from './types.js';

/**
 * Create a RuneForm instance from custom validation functions
 */
export function createForm<T extends Record<string, unknown>>(
	validator: CustomValidator<T>,
	initialData?: Partial<T>
) {
	return new RuneForm<T>(createCustomValidator(validator), initialData);
}
